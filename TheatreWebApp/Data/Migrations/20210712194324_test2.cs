    ...
    public partial class test2 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OnlineTickets", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OnlineTickets_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OnlineTickets_ReservationStatuses_ReservationStatusId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Shows_Plays_PlayId",
                        column: x => x.PlayId,
                        principalTable: "Plays",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Shows_Stages_StageId",
                        column: x => x.StageId,
                        principalTable: "Stages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Reservations_OnlineTickets_TicketId",
                        column: x => x.TicketId,
                        principalTable: "OnlineTickets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OnlineTickets_ApplicationUserId",
                table: "OnlineTickets",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_OnlineTickets_ReservationStatusId",
                table: "OnlineTickets",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Shows_PlayId",
                table: "Shows",
                column: "PlayId");

            migrationBuilder.CreateIndex(
                name: "IX_Shows_StageId",
                table: "Shows",
                column: "StageId");
        }
